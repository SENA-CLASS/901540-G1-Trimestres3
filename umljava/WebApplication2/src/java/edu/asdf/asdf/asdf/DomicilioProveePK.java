...
public class DomicilioProveePK implements Serializable {
    ...
    public String toString() {
        return "edu.asdf.asdf.asdf.DomicilioProveePK[ proveedorTipoDocumentoTipoDocumento=" + proveedorTipoDocumentoTipoDocumento + ", proveedorNumDocumento=" + proveedorNumDocumento + " ]";
    }
