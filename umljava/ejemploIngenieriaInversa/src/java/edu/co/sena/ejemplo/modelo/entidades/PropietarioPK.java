 ...
 */
package edu.co.sena.ejemplo.modelo.entidades;
...
public class PropietarioPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.ejemplo.modelo.entidades.PropietarioPK[ equipoSerial=" + equipoSerial + ", cuentaTipoDocumentotipodocumento=" + cuentaTipoDocumentotipodocumento + ", cuentanumeroDocumento=" + cuentanumeroDocumento + " ]";
    }
