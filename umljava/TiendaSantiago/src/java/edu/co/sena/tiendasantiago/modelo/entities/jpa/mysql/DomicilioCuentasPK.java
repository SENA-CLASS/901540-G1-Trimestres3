...
public class DomicilioCuentasPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.tiendasantiago.modelo.entities.jpa.mysql.DomicilioCuentasPK[ cuentaTipoDocumentoTipoDocumento=" + cuentaTipoDocumentoTipoDocumento + ", cuentaNumeroDocumento=" + cuentaNumeroDocumento + " ]";
    }
