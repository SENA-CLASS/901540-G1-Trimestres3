...
import edu.co.sena.tiendasantiago.controller.ejbs.ProveedorFacade;
...
public class ProveedorController implements Serializable {
    ...
    @EJB
    private edu.co.sena.tiendasantiago.controller.ejbs.ProveedorFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setProveedorPK(new edu.co.sena.tiendasantiago.modelo.entities.jpa.mysql.ProveedorPK());
    }
    ...
    public static class ProveedorControllerConverter implements Converter {
        ...
        edu.co.sena.tiendasantiago.modelo.entities.jpa.mysql.ProveedorPK getKey(String value) {
            edu.co.sena.tiendasantiago.modelo.entities.jpa.mysql.ProveedorPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new edu.co.sena.tiendasantiago.modelo.entities.jpa.mysql.ProveedorPK();
            key.setTipoDocumentoTipoDocumento(values[0]);
            key.setNumDocumento(values[1]);
            return key;
        }

        String getStringKey(edu.co.sena.tiendasantiago.modelo.entities.jpa.mysql.ProveedorPK value) {
