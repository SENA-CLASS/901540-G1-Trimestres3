...
public class CuentaPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.tiendasantiago.modelo.entities.jpa.mysql.CuentaPK[ tipoDocumentoTipoDocumento=" + tipoDocumentoTipoDocumento + ", numeroDocumento=" + numeroDocumento + " ]";
    }
