...
import edu.co.sena.tiendasantiago.modelo.entities.jpa.mysql.Cuenta;
...
import edu.co.sena.tiendasantiago.controller.ejbs.CuentaFacade;
...
public class CuentaController implements Serializable {
    ...
    @EJB
    private edu.co.sena.tiendasantiago.controller.ejbs.CuentaFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setCuentaPK(new edu.co.sena.tiendasantiago.modelo.entities.jpa.mysql.CuentaPK());
    }
    ...
    public static class CuentaControllerConverter implements Converter {
        ...
        edu.co.sena.tiendasantiago.modelo.entities.jpa.mysql.CuentaPK getKey(String value) {
            edu.co.sena.tiendasantiago.modelo.entities.jpa.mysql.CuentaPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new edu.co.sena.tiendasantiago.modelo.entities.jpa.mysql.CuentaPK();
            key.setTipoDocumentoTipoDocumento(values[0]);
            key.setNumeroDocumento(values[1]);
            return key;
        }

        String getStringKey(edu.co.sena.tiendasantiago.modelo.entities.jpa.mysql.CuentaPK value) {
