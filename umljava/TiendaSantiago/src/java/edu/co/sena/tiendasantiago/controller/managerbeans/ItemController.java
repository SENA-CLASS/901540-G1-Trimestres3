...
import edu.co.sena.tiendasantiago.modelo.entities.jpa.mysql.Item;
...
import edu.co.sena.tiendasantiago.controller.ejbs.ItemFacade;
...
public class ItemController implements Serializable {
    ...
    @EJB
    private edu.co.sena.tiendasantiago.controller.ejbs.ItemFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setItemPK(new edu.co.sena.tiendasantiago.modelo.entities.jpa.mysql.ItemPK());
    }
    ...
    public static class ItemControllerConverter implements Converter {
        ...
        edu.co.sena.tiendasantiago.modelo.entities.jpa.mysql.ItemPK getKey(String value) {
            edu.co.sena.tiendasantiago.modelo.entities.jpa.mysql.ItemPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new edu.co.sena.tiendasantiago.modelo.entities.jpa.mysql.ItemPK();
            key.setProductoIdProducto(values[0]);
            key.setPedidoFacturaIdFactura(Integer.parseInt(values[1]));
            return key;
        }

        String getStringKey(edu.co.sena.tiendasantiago.modelo.entities.jpa.mysql.ItemPK value) {
