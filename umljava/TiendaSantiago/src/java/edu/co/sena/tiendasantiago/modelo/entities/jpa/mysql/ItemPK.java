...
public class ItemPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.tiendasantiago.modelo.entities.jpa.mysql.ItemPK[ productoIdProducto=" + productoIdProducto + ", pedidoFacturaIdFactura=" + pedidoFacturaIdFactura + " ]";
    }
