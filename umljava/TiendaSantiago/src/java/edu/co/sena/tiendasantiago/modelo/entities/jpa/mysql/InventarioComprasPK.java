...
public class InventarioComprasPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.tiendasantiago.modelo.entities.jpa.mysql.InventarioComprasPK[ idInventario=" + idInventario + ", productoIdProducto=" + productoIdProducto + ", proveedorTipoDocumentoTipoDocumento=" + proveedorTipoDocumentoTipoDocumento + ", proveedorNumDocumento=" + proveedorNumDocumento + " ]";
    }
