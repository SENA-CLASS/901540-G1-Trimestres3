...
public class ItemCarritoPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.tiendasantiago.modelo.entities.jpa.mysql.ItemCarritoPK[ carritoComprasIdCarrito=" + carritoComprasIdCarrito + ", productoIdProducto=" + productoIdProducto + " ]";
    }
