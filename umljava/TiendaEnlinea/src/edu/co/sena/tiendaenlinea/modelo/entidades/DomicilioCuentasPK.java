...
public class DomicilioCuentasPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.tiendaenlinea.modelo.entidades.DomicilioCuentasPK[ cuentaTipoDocumentoTipoDocumento=" + cuentaTipoDocumentoTipoDocumento + ", cuentaNumeroDocumento=" + cuentaNumeroDocumento + " ]";
    }
