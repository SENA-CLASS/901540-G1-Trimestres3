...
public class DomicilioProveePK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.tiendaenlinea.modelo.entidades.DomicilioProveePK[ proveedorTipoDocumentoTipoDocumento=" + proveedorTipoDocumentoTipoDocumento + ", proveedorNumDocumento=" + proveedorNumDocumento + " ]";
    }
