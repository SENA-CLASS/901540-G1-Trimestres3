...
public class InventarioComprasPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.tiendaenlinea.modelo.entidades.InventarioComprasPK[ idInventario=" + idInventario + ", productoIdProducto=" + productoIdProducto + ", proveedorTipoDocumentoTipoDocumento=" + proveedorTipoDocumentoTipoDocumento + ", proveedorNumDocumento=" + proveedorNumDocumento + " ]";
    }
