...
import edu.co.ws.TipoDocumento;
...
public class TipoDocumentoFacadeREST extends AbstractFacade<TipoDocumento> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") String id, TipoDocumento entity) {
        super.edit(entity);
    }
    ...
    public TipoDocumento find(@PathParam("id") String id) {
