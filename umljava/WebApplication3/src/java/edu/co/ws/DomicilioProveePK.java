...
public class DomicilioProveePK implements Serializable {
    ...
    public String toString() {
        return "edu.co.ws.DomicilioProveePK[ proveedorTipoDocumentoTipoDocumento=" + proveedorTipoDocumentoTipoDocumento + ", proveedorNumDocumento=" + proveedorNumDocumento + " ]";
    }
