package edu.co.sena.prueba1.controlador.managerbeans;

import edu.co.sena.prueba1.modelo.pojos.Cliente;
import edu.co.sena.prueba1.controlador.managerbeans.util.JsfUtil;
import edu.co.sena.prueba1.controlador.managerbeans.util.JsfUtil.PersistAction;
import edu.co.sena.prueba1.controlador.ejs.ClienteFacade;
...
public class ClienteController implements Serializable {
    ...
    @EJB
    private edu.co.sena.prueba1.controlador.ejs.ClienteFacade ejbFacade;
    ...
    public static class ClienteControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Cliente) {
                ...
                return getStringKey(o.getCedulaCliente());
            } else {
