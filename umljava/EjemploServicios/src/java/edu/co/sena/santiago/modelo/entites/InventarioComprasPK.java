 ...
 */
package edu.co.sena.santiago.modelo.entites;
...
public class InventarioComprasPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.santiago.modelo.entites.InventarioComprasPK[ idInventario=" + idInventario + ", productoIdProducto=" + productoIdProducto + ", proveedorTipoDocumentoTipoDocumento=" + proveedorTipoDocumentoTipoDocumento + ", proveedorNumDocumento=" + proveedorNumDocumento + " ]";
    }
