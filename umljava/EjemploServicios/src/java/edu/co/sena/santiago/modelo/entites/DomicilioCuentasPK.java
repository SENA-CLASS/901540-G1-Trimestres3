...
public class DomicilioCuentasPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.santiago.modelo.entites.DomicilioCuentasPK[ cuentaTipoDocumentoTipoDocumento=" + cuentaTipoDocumentoTipoDocumento + ", cuentaNumeroDocumento=" + cuentaNumeroDocumento + " ]";
    }
