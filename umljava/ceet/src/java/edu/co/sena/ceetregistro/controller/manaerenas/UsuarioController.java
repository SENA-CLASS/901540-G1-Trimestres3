...
import edu.co.sena.ceetregistro.model.entiies.Usuario;
...
import edu.co.sena.ceetregistro.controller.ejbs.UsuarioFacade;
...
public class UsuarioController implements Serializable {
    ...
    @EJB
    private edu.co.sena.ceetregistro.controller.ejbs.UsuarioFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setUsuarioPK(new edu.co.sena.ceetregistro.model.entiies.UsuarioPK());
    }
    ...
    public static class UsuarioControllerConverter implements Converter {
        ...
        edu.co.sena.ceetregistro.model.entiies.UsuarioPK getKey(String value) {
            edu.co.sena.ceetregistro.model.entiies.UsuarioPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new edu.co.sena.ceetregistro.model.entiies.UsuarioPK();
            key.setCuentaTipoDocumentotipodocumento(values[0]);
            key.setCuentanumeroDocumento(values[1]);
            return key;
        }

        String getStringKey(edu.co.sena.ceetregistro.model.entiies.UsuarioPK value) {
